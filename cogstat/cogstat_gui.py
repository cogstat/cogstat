        ...
        menu_commands = [
                            [_('&Data'),
                                ['/icons8-folder.svg', _('&Open data file')+'...', _('Ctrl+O'),
                                 ...
                                 [_('import'), _('Spreadsheet file'), 'excel', 'spss', 'jamovi', 'jasp', 'sas', 'stata', 'r']],
                            ...
                            [_('&Analysis'),
                                ...
                                ['/icons8-scatter-plot.svg', _('Explore relation of variable &pair')+'...',
                                 ...
                                 [_('Scatter plot'), _('Linear regression'), _('Pearson correlation'), _('Spearman correlation'), _('R2'), _('AIC'), _('BIC'), _("Cramér's V"), _('Residual plot'), _('Henze-Zirkler test'), _("Koenker’s test"), _("White's test"), _('Variance inflation factors'), _('VIF'), _('Contingency table'), _('Chi-squared test')]],
                                ...
                                ['/icons8-combo-chart.svg', _('Compare repeated &measures variables')+'...',
                                 ...
                                 [_('Within-subject'), _('Spaghetti plot'), _('Mosaic plot'), _('Cohen’s d'), _('Eta-squared'), _('Shapiro-Wilk test'), _('Paired t-test'), _('Paired Wilcoxon test'), _('McNemar test'), _('Repeated measures ANOVA'),_('Mauchly’s sphericity test'), _('Greenhouse-Geisser correction'), _('Holm-Bonferroni correction'), _('Friedman test'), _('Durbin-Conover test'), _("Cochran's Q-test")]],
                                ...
                                ['/icons8-collect-100.png', _('&Interrater reliability analysis')+'...',
                                 ...
                                 [_('Intraclass correlation'), _('ICC'), _('Absolute agreement'), _('Relative agreement')]],
                                ['separator'],
                                ['toolbar separator'],
