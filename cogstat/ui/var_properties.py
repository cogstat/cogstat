...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.ttest_value = QtWidgets.QLineEdit(parent=Dialog)
        ...
        self.ttest_value.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.ttest_value.setObjectName("ttest_value")
        self.gridLayout.addWidget(self.ttest_value, 2, 1, 1, 1)
        self.freq_checkbox = QtWidgets.QCheckBox(parent=Dialog)
