...
def create_multiple_variable_chart(data, meas_lev, x, type="raw"):
    ...
    x : str
        Name of the x variable.
    type : {'raw', 'collinearity'}
        Displays raw data when 'raw', displays scatterplot matrix of explanatory variables when 'collinearity'.
...
def part_regress_plots(y, x, data):
    ...
    -------
    matplotlib chart
        A matrix plot of the variables containing the residuals from the respective partial regressions.
    """
